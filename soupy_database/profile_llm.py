"""
LLM side of the member-profile builder: the prompt, the edit-list JSON schema,
...
from .profile_document import RULE_EXAMPLES, SECTION_KEYS, SECTIONS
...
def edits_json_schema() -> Dict[str, Any]:
    ...
    while True:
        ...
        if mode == "json_schema":
            payload["response_format"] = {
                "type": "json_schema",
                "json_schema": {"name": "profile_edits", "strict": True, "schema": edits_json_schema()},
            }
